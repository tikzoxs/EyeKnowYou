...
parser.add_argument('--screen', action="store", type=np.uint8, default=0) #optional 
parser.add_argument('--cogload', action="store", type=np.uint8, default=0) #optional
parser.add_argument('--tasknumber', action="store", type=np.uint8, default=0) #optional
parser.add_argument('--camera', required=True, type=np.uint8) #required
parser.add_argument('--filepath', required=True, help='Where to save the file') #required
...
for i in range(len(X)):
	resized_X.append(resize_img(X[i]))
